...
# %%
dataset_version = 'vc_holy_grail'

success_name = 'vc_holy_grail_data_w_sucess'
success_path = dataset_raw_dir_path(success_name, dataset_version)

# %%
success_files = io_api.list_files_in_dir(success_path)

# %%
success = io_api.load_pandas_dataset(success_files, index_col=0)
